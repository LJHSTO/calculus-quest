...
学习模块 ID：EXT-02
学习模块名称：线性代数基础
先修要求：建议完成 V14-C4 后学习。

本模块现有知识点：
- ID：EXT-02-K01
  名称：向量和向量空间直觉
  学习目标：能解释「向量和向量空间直觉」的核心含义，并用交互证据说明自己的判断。
  常见误解：只记住「向量和向量空间直觉」的符号或结论，没有把它和图像、操作或应用情境连接起来。
- ID：EXT-02-K02
  名称：矩阵运算与线性变换
  学习目标：能解释「矩阵运算与线性变换」的核心含义，并用交互证据说明自己的判断。
  常见误解：只记住「矩阵运算与线性变换」的符号或结论，没有把它和图像、操作或应用情境连接起来。
- ID：EXT-02-K03
  名称：行列式、逆矩阵与线性方程组
  学习目标：能解释「行列式、逆矩阵与线性方程组」的核心含义，并用交互证据说明自己的判断。
  常见误解：只记住「行列式、逆矩阵与线性方程组」的符号或结论，没有把它和图像、操作或应用情境连接起来。
- ID：EXT-02-K04
  名称：特征值与特征向量
  学习目标：能解释「特征值与特征向量」的核心含义，并用交互证据说明自己的判断。
  常见误解：只记住「特征值与特征向量」的符号或结论，没有把它和图像、操作或应用情境连接起来。
- ID：EXT-02-K05
  名称：正交性与投影
  学习目标：能解释「正交性与投影」的核心含义，并用交互证据说明自己的判断。
  常见误解：只记住「正交性与投影」的符号或结论，没有把它和图像、操作或应用情境连接起来。
...
1. id="EXT-02-pre"；title="前测：线性代数基础（A卷）"；order=1。
2. id="EXT-02-post"；title="后测：线性代数基础（B卷）"；order=2。
...
每个题目对象完整写出 id、type、question、options（text 除外）、answer、analysis、points、knowledgePointIds、cognitiveLevel、estimatedSteps、pairId 和 equivalence。题目 id 必须严格为 EXT-02-pre-q1 至 EXT-02-pre-q6、EXT-02-post-q1 至 EXT-02-post-q6，不得缩写、重复或增加 q6b 等变体；pairId 必须按题位严格使用 P01 至 P06，每卷各出现一次。
