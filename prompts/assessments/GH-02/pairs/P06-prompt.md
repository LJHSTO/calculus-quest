...
1. id="GH-02-pre-P06"，title="前测题对 P06"，order=1，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["single"]}。
2. id="GH-02-post-P06"，title="后测题对 P06"，order=2，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["single"]}。
...
pre.id 必须为 "GH-02-pre-q6"；post.id 必须为 "GH-02-post-q6"。两题的 pairId 都必须为 "P06"，type 都必须为 "single"，points 都必须为 8。
