...
1. id="GH-02-pre-P02"，title="前测题对 P02"，order=1，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["single"]}。
2. id="GH-02-post-P02"，title="后测题对 P02"，order=2，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["single"]}。
