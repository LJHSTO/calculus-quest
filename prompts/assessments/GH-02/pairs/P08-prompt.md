...
1. id="GH-02-pre-P08"，title="前测题对 P08"，order=1，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["multiple"]}。
2. id="GH-02-post-P08"，title="后测题对 P08"，order=2，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["multiple"]}。
...
pre.id 必须为 "GH-02-pre-q8"；post.id 必须为 "GH-02-post-q8"。两题的 pairId 都必须为 "P08"，type 都必须为 "multiple"，points 都必须为 12。
