...
1. id="GH-02-pre-P07"，title="前测题对 P07"，order=1，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["single"]}。
2. id="GH-02-post-P07"，title="后测题对 P07"，order=2，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["single"]}。
...
pre.id 必须为 "GH-02-pre-q7"；post.id 必须为 "GH-02-post-q7"。两题的 pairId 都必须为 "P07"，type 都必须为 "single"，points 都必须为 8。
