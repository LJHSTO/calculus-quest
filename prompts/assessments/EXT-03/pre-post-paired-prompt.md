...
- ID：EXT-03-K01
  名称：随机事件与概率公理
  学习目标：能解释「随机事件与概率公理」的核心含义，并用交互证据说明自己的判断。
  常见误解：只记住「随机事件与概率公理」的符号或结论，没有把它和图像、操作或应用情境连接起来。
- ID：EXT-03-K02
  名称：条件概率与贝叶斯
  学习目标：能解释「条件概率与贝叶斯」的核心含义，并用交互证据说明自己的判断。
  常见误解：只记住「条件概率与贝叶斯」的符号或结论，没有把它和图像、操作或应用情境连接起来。
- ID：EXT-03-K03
  名称：随机变量与分布
  学习目标：能解释「随机变量与分布」的核心含义，并用交互证据说明自己的判断。
  常见误解：只记住「随机变量与分布」的符号或结论，没有把它和图像、操作或应用情境连接起来。
- ID：EXT-03-K04
  名称：期望、方差与大数定律
  学习目标：能解释「期望、方差与大数定律」的核心含义，并用交互证据说明自己的判断。
  常见误解：只记住「期望、方差与大数定律」的符号或结论，没有把它和图像、操作或应用情境连接起来。
- ID：EXT-03-K05
  名称：常见分布与中心极限定理
  学习目标：能解释「常见分布与中心极限定理」的核心含义，并用交互证据说明自己的判断。
