...
assert.equal(flowJsVersion, "20260726-flow-test-cache-v6");
...
assert.match(css, /\.viewer-pane:fullscreen \.slide-preview:not\(\[hidden\]\)/);
assert.match(css, /\.viewer-pane:fullscreen \.flow-slide-wrap/);
