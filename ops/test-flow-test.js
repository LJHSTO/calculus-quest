...
const agenticPath = fs.readFileSync(path.join(root, "app", "main", "agentic-path.js"), "utf8");
const bootstrap = fs.readFileSync(path.join(root, "app", "main", "bootstrap.js"), "utf8");
const navigation = fs.readFileSync(path.join(root, "app", "main", "navigation.js"), "utf8");
...
assert.equal(formalStyleVersion, "20260819-v2-score-evidence-v1");
const formalCoreScriptVersion = mainHtml.match(/app\/main\/core\.js\?v=([^"]+)/)?.[1];
assert.ok(formalCoreScriptVersion);
assert.equal(formalCoreScriptVersion, "20260819-v2-score-evidence-v1");
assert.match(agenticPath, /function agenticRenderKnowledgeTransitionPanel/);
assert.match(agenticPath, /function agenticRenderKnowledgeTransitionPreviewPanel/);
assert.match(agenticPath, /function agenticKnowledgeTransitionPreviewFor/);
assert.match(agenticPath, /node\.innerHTML = agenticRenderKnowledgeTransitionPanel/);
assert.match(agenticPath, /node\.innerHTML = agenticRenderKnowledgeTransitionPreviewPanel/);
assert.match(agenticPath, /function focusKnowledgeTransitionChoice/);
assert.match(agenticPath, /function agenticKnowledgeTransitionCtaFor/);
assert.doesNotMatch(bootstrap, /function renderKnowledgeTransitionChoice/);
assert.match(bootstrap, /dataset\.focusKnowledgeTransition/);
assert.match(navigation, /focusKnowledgeTransitionChoice/);
