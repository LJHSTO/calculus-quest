...
1. id="GH-02-pre-${pairId}"，title="前测题对 ${pairId}"，order=1，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["${type}"]}。
2. id="GH-02-post-${pairId}"，title="后测题对 ${pairId}"，order=2，difficulty="medium"，quizConfig={"questionCount":1,"difficulty":"medium","questionTypes":["${type}"]}。
