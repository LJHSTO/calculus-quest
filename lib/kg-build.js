...
const DEFAULT_ROUTE_PATH = path.join("data", "openmaic-v14-route.json");
...
function buildKnowledgeGraph(route) {
  ...
  return {
    schemaVersion: "2.0.0",
    generatedAt: route.generatedAt || route.versionId || "v14",
    source: DEFAULT_ROUTE_PATH.replace(/\\/g, "/"),
    sourceVersion: route.versionId || route.schemaVersion || "v14",
    description: "由当前 OpenMAIC V14 route 自动生成的 Agentic Coach 知识图谱。",
