...
function validateCoursewareFeedbackTarget(value = {}, nodeById = () => null) {
  ...
  return {
    ...
    value: {
      ...
      scene_type: cleanText(candidate.type || candidate.widgetType, 80),
      resource_file: cleanText(candidate.file, 500),
      resource_title: cleanText(candidate.title || candidate.file, 500)
    }
  };
}
